...
version = "1.4.1" #Version Control
debug = "" #Debug Title Control

for argument in sys.argv:
    if argument == "--version" or argument == "-v":
        print "Crazy China Pong version "+version and sys.exit()
    if argument == "--credits":
        print "Crazy China Pong "+version+" Credits:\n\n"+\
            ...
            "Artwork           : SmartViking" and sys.exit()
...
def main(startup=0):
    ...
    while 1:
        ...
        if guyw < 0:
            writefile = 1
            while 1: #Pause screen rendering
                screen.blit(bg,(0,0))
